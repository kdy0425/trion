...
<div class="sub_top">
        <div class="page_location scroll_reveal to_bottom reveal_sm reveal_once reveal_delay_3">
            ...
            <div class="item"> <a href="/solution/treasury_subsidy.asp">국고 보조금 관리시스템</a> </div>
        </div>
        <h2 class="scroll_reveal to_bottom reveal_sm reveal_once reveal_delay_5">국고 보조금 관리시스템</h2>
        ...
        <div class="local_nav">
            ...
            <div class="item"><a href="/solution/treasury_subsidy.asp"  class="active"><span>국고 보조금 관리시스템</span></a></div>
	...
	<div class="mobile_tab_nav">
		...
		<div class="item">
			<a href="/solution/treasury_subsidy.asp"><span>국고 보조금 관리시스템</span></a>
			<ul>
				<li><a href="/solution/ai.asp">AI</a></li>
				<li><a href="/solution/blockchain.asp">Blockchain</a></li>
				<li><a href="/solution/treasury_subsidy.asp"  class="active">국고 보조금 관리시스템</a></li>
	...
	<div id="content" class="sub_content">
        <div class="sub_title_visual">
			<div class="container">
                <div class="title_area scroll_reveal to_right show_center">
                    <div class="cate">보조금 전 과정을 자동화</div>
                    <div class="title">투명하고 스마트한 행정 혁신의 시작 <br class="pc"/>보조금 관리시스템</div>
                    <p>공공기관에서 제공하는 각종 보조금을 전산화하여 효율적으로 관리하고, <br class="pc"/>카드와 전자바우처를 이용한 서비스를 제공합니다.</p>
                </div>
                <div class="bg scroll_reveal to_left show_center pc" style="background-image:url('/assets/images/content/sub_visual_treasury_subsidy.jpg')"></div>
                <div class="bg scroll_reveal to_left show_center mobile" style="background-image:url('/assets/images/content/sub_visual_treasury_subsidy_mobile.jpg')"></div>
            </div>
		</div>
        ...
        <div class="sub_section scroll_reveal to_bottom show_center">
            <div class="container">
                ...
                <div class="check_text_box">
                    <div class="item">보조금을 신청부터 사후관리까지 모든 과정을 통합 관리하며, 다양한 지급 채널을 통해 효율적이고 투명하게 보조금을 집행합니다.</div>
                </div>
            </div>
        </div>
        <div class="sub_section scroll_reveal to_bottom show_center">
            <div class="container">
                ...
                <div class="diagram_step">
                    <div class="item">
                        <div class="tit">보조금 신청접수</div>
                        <div class="num">1</div>
                    </div>
                    <div class="item">
                        <div class="tit">보조금 심사</div>
                        <div class="num">2</div>
                    </div>
                    <div class="item">
                        <div class="tit">보조금 선정</div>
                        <div class="num">3</div>
                    </div>
                    <div class="item">
                        <div class="tit">보조금 지급</div>
                        <div class="num">4</div>
                    </div>
                </div>
            </div>
        ...
        <div class="sub_section scroll_reveal to_bottom show_center">
            <div class="container">
                ...
                <div class="diagram_oganization">
                    <div class="top">보조금 관리시스템</div>
                    <div class="list">
                        <div class="item">
                            <div class="tit">사업관리</div>
                            <ul>
                                <li>사업관리</li>
                                <li>예산관리</li>
                            </ul>
                        ...
                        <div class="item">
                            <div class="tit">보조금 대상 관리</div>
                            <ul>
                                <li>보조금 신청접수/심사/선정/지급</li>
                                <li>자격정지/환수</li>
                            </ul>
                        </div>
                        <div class="item">
                            <div class="tit">정산/통계</div>
                            <ul>
                                <li>사용내역 검증</li>
                                <li>보조금 정산</li>
                                <li>각종 통계</li>
        ...
        <div class="sub_section scroll_reveal to_bottom show_center">
            <div class="container">
                ...
                <div class="tit_grid">
                   <div class="item">카드 바우처</div>
                   <div class="item">계좌이체</div>
                   <div class="item">현금</div>
                </div>
            </div>
        </div>
        <div class="sub_section scroll_reveal to_bottom show_center">
